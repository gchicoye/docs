...
To view your bills, go to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=we){.external}, and open the `Invoices`{.action} section by clicking on your name in the top right-hand corner. 
